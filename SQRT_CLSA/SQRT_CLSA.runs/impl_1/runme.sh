...
HD_PWD='C:/Users/User/Documents/Projects/SQRT_CLSA/SQRT_CLSA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SQRT_CSLA_64bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SQRT_CSLA_64bit.tcl -notrace
