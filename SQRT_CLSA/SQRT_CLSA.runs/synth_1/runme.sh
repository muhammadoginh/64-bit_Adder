...
HD_PWD='C:/Users/User/Documents/Projects/SQRT_CLSA/SQRT_CLSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SQRT_CSLA_64bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SQRT_CSLA_64bit.tcl
