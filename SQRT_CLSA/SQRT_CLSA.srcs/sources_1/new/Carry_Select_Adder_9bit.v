module Carry_Select_Adder_9bit(
    ...
    // intermediate
    wire [8:0] Sum0; // sum for "0" carry propagation
    wire [8:0] Sum1; // sum for "1" carry propagation
    wire [7:0] Carry0; // intermediate for "0" carry propagation
    wire [7:0] Carry1; // intermediate for "1" carry propagation
    ...
    Full_Adder FA0_9(A[8],B[8],Carry0[7],Cout0,Sum0[8]);
    ...
    Full_Adder FA1_9(A[8],B[8],Carry1[7],Cout1,Sum1[8]);
