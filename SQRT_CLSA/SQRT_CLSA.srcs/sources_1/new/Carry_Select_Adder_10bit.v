module Carry_Select_Adder_10bit(
    input [9:0] A,
    input [9:0] B,
    input Cin,
    output Cout,
    ...
    // intermediate
    wire [9:0] Sum0; // sum for "0" carry propagation
    wire [9:0] Sum1; // sum for "1" carry propagation
    wire [8:0] Carry0; // intermediate for "0" carry propagation
    wire [8:0] Carry1; // intermediate for "1" carry propagation
    ...
    Full_Adder FA0_10(A[9],B[9],Carry0[8],Cout0,Sum0[9]);
    ...
    Full_Adder FA1_10(A[9],B[9],Carry1[8],Cout1,Sum1[9]);
