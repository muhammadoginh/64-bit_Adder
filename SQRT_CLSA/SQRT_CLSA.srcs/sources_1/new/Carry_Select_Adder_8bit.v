module Carry_Select_Adder_8bit(
    ...
    // intermediate
    wire [7:0] Sum0; // sum for "0" carry propagation
    wire [7:0] Sum1; // sum for "1" carry propagation
    wire [6:0] Carry0; // intermediate for "0" carry propagation
    wire [6:0] Carry1; // intermediate for "1" carry propagation
    ...
    Full_Adder FA0_8(A[7],B[7],Carry0[6],Cout0,Sum0[7]);
    ...
    Full_Adder FA1_8(A[7],B[7],Carry1[6],Cout1,Sum1[7]);
