module Carry_Select_Adder_5bit(
    ...
    // intermediate
    wire [4:0] Sum0; // sum for "0" carry propagation
    wire [4:0] Sum1; // sum for "1" carry propagation
    wire [3:0] Carry0; // intermediate for "0" carry propagation
    wire [3:0] Carry1; // intermediate for "1" carry propagation
    ...
    Full_Adder FA0_5(A[4],B[4],Carry0[3],Cout0,Sum0[4]);
    ...
    Full_Adder FA1_5(A[4],B[4],Carry1[3],Cout1,Sum1[4]);
