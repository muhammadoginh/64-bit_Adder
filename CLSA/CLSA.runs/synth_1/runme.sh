...
HD_PWD='C:/Users/User/Documents/Projects/CLSA/CLSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CSLA_64bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CSLA_64bit.tcl
