...
HD_PWD='C:/Users/User/Documents/Projects/CLSA/CLSA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CSLA_64bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CSLA_64bit.tcl -notrace
